...
/**
 * Created by yangdan on 15/10/28.
 */
public class CirclePageIndicator extends View {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorRadius = typedArray.getDimensionPixelSize(R.styleable.CirclePageIndicator_ci_radius, DEFAULT_INDICATOR_RADIUS);
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.CirclePageIndicator_ci_margin, DEFAULT_INDICATOR_MARGIN);
        mIndicatorBackground = typedArray.getColor(R.styleable.CirclePageIndicator_ci_background, DEFAULT_INDICATOR_BACKGROUND);
        mIndicatorSelectedBackground = typedArray.getColor(R.styleable.CirclePageIndicator_ci_selected_background,DEFAULT_INDICATOR_SELECTED_BACKGROUND);
        int gravity = typedArray.getInt(R.styleable.CirclePageIndicator_ci_gravity,DEFAULT_INDICATOR_LAYOUT_GRAVITY);
        mIndicatorLayoutGravity = Gravity.values()[gravity];
        int mode = typedArray.getInt(R.styleable.CirclePageIndicator_ci_mode,DEFAULT_INDICATOR_MODE);
    ...
    private void trigger(int position,float positionOffset){
        CirclePageIndicator.this.mCurItemPosition = position;
        CirclePageIndicator.this.mCurItemPositionOffset = positionOffset;
